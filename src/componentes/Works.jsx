  ...
  return (
    <div id="aboutUs" className="p-8 xl:p-20">
      <div className="mb-8">
        ...
        ¡Prepárate para la batalla más épica de Fortnite!
        </p>
        <p>
        echa: [Fecha]
        Hora: [Hora]
        Plataforma: [Plataformas permitidas (PC, Consolas, Móvil)]

        ¡Inscríbete ya y conviértete en una leyenda de Fortnite!
        </p>
      </div>
      {/* Works */}
